...
public class Tabtables {
	 ...
	 * On parcourt tout le tableau, qu'il pointe vers une référence ou qu'il pointe vers null
	 * Pour enlever ceux qui pointent vers null, on utilise le if uneTable!=null
	 * uneTable est une référence ; java va copier
	 * tableauDeTables.tabTable[0], et le contenu vers lequel il pointe (attributs nb_pieds, couleur,etc...)
	 * On utilise la méthode afficher de la classe table, pour afficher le contenu de la table 
	 *  
	 */
	void afficherTable(){ 
