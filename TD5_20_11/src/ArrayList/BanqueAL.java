...
//	private CompteEpargne [] tabepargne;
	...
	// Constructeur
	BanqueAL(){
		tabcomptes = new ArrayList <CompteCourant> (TAILLEMAX);
		tabepargne = new ArrayList <CompteEpargne> (TAILLEMAX);
	}
	
	BanqueAL (int nbComptes){
		tabcomptes = new ArrayList <CompteCourant> (nbComptes);
		tabepargne = new ArrayList <CompteEpargne> (nbEpargne);
	...
	public void ajouterCompte(CompteCourant nouveauCompte){
		tabcomptes.add(nouveauCompte);
	}

	public void ajouterCompte(CompteEpargne nouveauCompte){
		tabepargne.add(nouveauCompte);
	}
	...
	public String toString() {
		return "BanqueAL [tabcomptes=" + tabcomptes + ", tabepargne=" + tabepargne + "]";
	}
	...
	public static void main(String[] args){
		...
		// 2 - Tableau d'objets
		BanqueAL banqueOrsay = new BanqueAL(2);
		banqueOrsay.ajouterCompte(cDupont);
		
		BanqueAL banqueBures = new BanqueAL(10);
